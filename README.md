...
<!-- codesight:counts ops=34 langs=66 tests=2560 -->
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-2560-brightgreen?style=flat-square" alt="Tests">
</p>
...
- **2,560 tests** — adversarial, security, integration, benchmark, fuzz, and stress coverage with real temp directories
